package o.w.o.domain.core.user.service.impl;

import com.querydsl.core.types.Predicate;
import lombok.extern.slf4j.Slf4j;
import o.w.o.domain.core.role.domain.Role;
import o.w.o.domain.core.user.constant.UserConstant;
...
public class UserServiceImpl implements UserService {
  ...
  @Cacheable(key = "'fb_uname#' + #username", condition = "#result?.isSuccess()", sync = true)
  @Override
  ...
  @Cacheable(key = "'fb_id#' + #id", condition = "#result?.isSuccess()", sync = true)
  @Override
  ...
  @CacheEvict(key = "'fb_id#' + #id", condition = "#result?.isSuccess()")
  @Override
