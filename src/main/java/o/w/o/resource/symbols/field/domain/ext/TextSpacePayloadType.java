...
import o.w.o.resource.symbols.field.repository.ext.TextSpacePayloadTypeRepository;
...
@Entity
@Table(name = "t_s_field__text_type")
public class TextSpacePayloadType {
  ...
  @EntityEnumerated(enumClass = TypeEnum.class, entityClass = TextSpacePayloadType.class, repositoryClass = TextSpacePayloadTypeRepository.class)
