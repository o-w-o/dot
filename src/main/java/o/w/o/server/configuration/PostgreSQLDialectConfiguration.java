...
/**
 * PostgreSQLDialectConfiguration
 *
 ...
 */
public class PostgreSQLDialectConfiguration extends PostgreSQL95Dialect {
   ...
   */
  public PostgreSQLDialectConfiguration() {
    super();
   ...
   * {@link PostgreSQLDialectConfiguration#register()} function. This will still allow you to use the functionality provided
   ...
   */
  public PostgreSQLDialectConfiguration(BiConsumer<Integer, String> registerColumnTypeConsumer, BiConsumer<String, SQLFunction> registerFunctionConsumer) {
    super();
