package ink.o.w.o.util.domainconverter.example;

import ink.o.w.o.util.domainconverter.AbstractDomainEnum;
...
public class DomainEnumWithConverter extends AbstractDomainEnum<DomainEnumWithConverter, Integer> {
  ...
  @Slf4j
  @Convert
  public static class DomainEnumConverter implements ink.o.w.o.util.domainconverter.DomainEnumConverter<DomainEnumWithConverter, Integer> {
    @Override
